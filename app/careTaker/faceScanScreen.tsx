...
//     "Ready to scan a familiar face.",
//   );

//   const activeFace =
//     FAMILIAR_FACES.find((face) => face.id === activeFaceId) ??
//     FAMILIAR_FACES[0];
...
//       },
//       body: JSON.stringify({ url: 'data:image/jpeg;base64,' + base64Image })
//     });

//     const faces = await response.json();

//     if (!faces || faces.length === 0) {
//       setScanResult("No face detected");
//       return;
//     }

//     const faceId = faces[0].faceId;

//     const activeFace = { name: "John", relation: "Son" };
...
//                     style={[
//                       styles.faceAvatar,
//                       isActive && styles.faceAvatarActive,
//                     ]}
//                   >
//                     <MaterialCommunityIcons
